...
func GenerateToken(employeeID int, ttl int, Role domain.Role, isRefresh bool) (string, error) {
	claims := CustomClaims{
...
func ParseToken(tokenString string) (employeeID int, isRefresh bool, role domain.Role, err error) {
